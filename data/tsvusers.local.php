...
'user_login_widget_view_template' => 'zfc-user/login.phtml',
...
return array(
    ...
    'tsvusers' => array(
        ...
        'register' => array(
        	/**
        	 * Enable register form for users via ixesten forms or Social Networks
        	 */
			'enabled' => false,
        	
        	/**
        	 * Enable or disable auth and registration in program via social networks
             *
             * Expects: bool
             * Default: false
        	 */
    	...
    	/**
    	 * Login and password for superuser must be change after first enter and creatibg administrator user
    	 */
    	'admin' =>	array(
    		/**
             * Expects: string
             ...
             * Default: passwd123
    		 */
    		'superpassword'	=> 'passwd123',
    		/**
    		 * Enable or disable auth with superuser account
    		 * 
             * Expects: bool
             * Default: false
    		 */
	...
	/**
	 * Rules for bjyauthorize
	 */
	'bjyauthorize' => array(
		'guards' => array(
			'BjyAuthorize\Guard\Controller' => array(
					array(
						'controller' => 'TsvUsers\Controller\TsvUsers',
						'roles'	=> array('admin'),
					),
			),
		),
